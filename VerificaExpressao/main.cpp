// Modifiquei a função Pilha_Desempilhar removendo seu parâmetro e seu metodo de salvar o elemento desempilhado em uma
// variável passada por referência, pois não será útil no código.
#include <iostream>
#include <cstring>
#include <cstdlib>
#include "Pilha.h"
